      ...
      <nav className='flex justify-between items-center relative w-full z-20'>
        ...
        <div className="block md:hidden">
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent className='bg-[#112240] flex justify-center items-center fixed top-0 right-0 bottom-0 p-[50px_10px] h-full border-0'>
                ...
                <SheetDescription asChild>
                  <nav className='flex justify-between items-center w-full flex-col text-slate-400 text-center mobilelinks'>
                    ...
                    <ol className='p-0 m-0 list-none w-full'>
                      <li onClick={() => setIsOpen(false)} className='m-[0px_auto_10px] relative counter text-[13px]'>
                    ...
                    <div onClick={() => setIsOpen(false)} className='hover:scale-105 w-full'>
